...
echo "Downloading Emerging Threat Feeds"
wget https://rules.emergingthreats.net/fwrules/emerging-Block-IPs.txt -O emerging-Block-IPs.tmp
echo "INDEX,IPADDR" >> emerging-Block-IPs.csv
convert_feed emerging-Block-IPs.tmp emerging-Block-IPs.csv ","
